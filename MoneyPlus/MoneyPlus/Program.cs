...
builder.Services.AddScoped<CashOutflowRepository>();
builder.Services.AddScoped<ReportsService>();

builder.Services.AddHostedService<CategoriesBackgroundService>();
builder.Services.AddHostedService<FakeEmailSenderBackgroundService>();
...
var defaultCultrure = new CultureInfo("en");
